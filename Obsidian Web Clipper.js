 ...
 * @desc This script will generate a new note in Obsidian containing the content of the current webpage. It only works on Apple devices. It utilizes Obsidian's [callout](https://help.obsidian.md/How+to/Use+callouts) and [tags](https://help.obsidian.md/How+to/Working+with+tags) syntax.
